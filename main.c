...
int main() {
    ...
    // segitiga
    clearScreen();
    // line(100,100,180,100,0,0,255,255,255);
    // line(100,100,100,180,0,0,255,255,255);
    // line(100,180,180,180,0,0,255,255,255);
    // line(180,100,180,180,0,0,255,255,255);
    // floodFill(140, 140, -1, -1, -1, 255);

    printChar('c', 0, 0, 255, 255, 255);
